...
export const HANDLE_BLUR_INTENSITY_IOS = 78;
export const HANDLE_BLUR_INTENSITY_ANDROID = 56;
export const HANDLE_FROST_TINT_OPACITY = 0.28;
...
export const BOTTOM_R_COLLAPSED = 10;
export const BOTTOM_R_FULL = 18;
